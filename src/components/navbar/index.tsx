      ...
      <main className={styles.container}>
        ...
        <nav className={styles.navbar}>
          <ul className={styles.navbar_items}>
            <li className={styles.navbar_item}>Collections</li>
            <li className={styles.navbar_item}>Men</li>
            <li className={styles.navbar_item}>Women</li>
        ...
        <div className={styles.action}>
          ...
          <ImageHOC
            classWrapper={styles.action_avatar}
